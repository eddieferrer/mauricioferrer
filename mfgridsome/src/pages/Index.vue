          ...
          <ul class="row portfolio list-unstyled lightbox" id="grid">
            ...
            <li class="col-xs-6 col-md-4 project m-project">
              <div class="img-bg-color primary">
                <a
                  href="projects/capitol_crossing/project.php"
                  class="project-link"
                >
                  <!-- / project-link -->
            ...
            <li class="col-xs-6 col-md-4 project m-project">
              <div class="img-bg-color primary">
                <a
                  href="projects/neuroscience/project.php"
                  class="project-link"
                >
                  <!-- / project-link -->
                ...
                <div class="project-details">
                  <h5 class="project-title">
                    NEUROSCIENCE & PSYCHOLOGY CENTER
                  </h5>
            ...
            <li class="col-xs-6 col-md-4 project m-project">
              <div class="img-bg-color primary">
                ...
                <div class="project-details">
                  <h5 class="project-title">
                    KEY COLONY PLAZA SHOPPING CENTER
                  </h5>
                  <p class="skill">KEY BISCAYNE, FL</p>
                </div>
                <!-- / project-details -->
            ...
            <li class="col-xs-6 col-md-4 project m-project">
              <div class="img-bg-color primary">
                <a
                  href="projects/345woodcrest/project.php"
                  class="project-link"
                >
                  <!-- / project-link -->
            ...
            <li class="col-xs-6 col-md-4 project m-project">
              <div class="img-bg-color primary">
                <a
                  href="projects/400woodcrest/project.php"
                  class="project-link"
                >
                  <!-- / project-link -->
