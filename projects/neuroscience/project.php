    ...
    <div id="header-banner">
        <div class="banner-content single-page text-center">
            <div class="banner-info">
                <h1>NEUROSCIENCE & PSYCHOLOGY CENTER<br/>AT PRINCETON UNIVERSITY</h1>
                <p>Princeton, NJ</p>
            </div><!-- / banner-info -->
        </div><!-- / banner-content -->
    </div>
...
<div id="page-content" class="container">
    <section id="project">
        ...
        <div class="row">
            <div class="col-sm-12">
              <h3>NEUROSCIENCE & PSYCHOLOGY CENTER AT PRINCETON UNIVERSITY</h3>
            </div>
            <div class="col-sm-4">
                <h4>PROJECT INFO</h4>
                <div class="project-info">
                    <div class="info">
                        <p><i class="lnr lnr-apartment"></i><span>Architectural Design by: Rafael Moneo</span></p>
                    </div>
                    <div class="info">
                        <p><i class="lnr lnr-map"></i><span>Location: Princeton, NJ</span></p>
                    </div>
                </div><!-- / project-info -->
            </div><!-- / col-sm-4 -->
            <div class="col-sm-8">
    ...
    <div class="pagination">
        <a href="/projects/saxony/project.php" class="btn btn-direction btn-default-filled"><i class="fa fa-long-arrow-left"></i><span>Previous Project</span></a>
        <a href="/projects/lanai/project.php" class="btn btn-direction btn-default-filled pull-right"><span>Next Project</span><i class="fa fa-long-arrow-right"></i></a>
